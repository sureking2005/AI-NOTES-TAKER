  ...
  return (
    <div className="upload-form">
      ...
      <p className="help-text">
        When prompted, select your Zoom/Meet tab and enable "Share tab audio". Allow microphone permission. Works best in Chrome.
      </p>
      ...
      <div className="form-group">
    <label className="form-label">Reference Transcript (Optional - .txt)</label>
    <label className="file-upload-label small">
      <input
        type="file"
        accept=".txt"
